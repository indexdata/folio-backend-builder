...
curl -w '\n' -D - -s -X POST -H "Content-type: application/json" -d @$GITFOLIO/mod-permissions/target/ModuleDescriptor.json http://localhost:9130/_/proxy/modules
echo Deploy mod-permissions
$FOLIO/install-folio-backend/templates/dd-pg.sh mod-permissions 6.4.0-SNAPSHOT $JAVA_11 $GITFOLIO target/mod-permissions-fat.jar localhost
...
$FOLIO/install-folio-backend/templates/dd-pg.sh mod-inventory-storage 26.1.0-SNAPSHOT $JAVA_11 $GITFOLIO target/mod-inventory-storage-fat.jar localhost
...
echo mod-users
curl -w '\n' -D - -s -X POST -H "Content-type: application/json" -d @$GITFOLIO/mod-users/target/ModuleDescriptor.json http://localhost:9130/_/proxy/modules
echo Deploy mod-users
$FOLIO/install-folio-backend/templates/dd-pg-kafka.sh mod-users 19.2.0-SNAPSHOT $JAVA_11 $GITFOLIO target/mod-users-fat.jar localhost
...
echo mod-login
curl -w '\n' -D - -s -X POST -H "Content-type: application/json" -d @$GITFOLIO/mod-login/target/ModuleDescriptor.json http://localhost:9130/_/proxy/modules
echo Deploy mod-login
$FOLIO/install-folio-backend/templates/dd-pg.sh mod-login 7.10.0-SNAPSHOT $JAVA_11 $GITFOLIO target/mod-login-fat.jar localhost
...
curl -w '\n' -D - -s -X POST -H "Content-type: application/json" -d @$GITFOLIO/mod-password-validator/target/ModuleDescriptor.json http://localhost:9130/_/proxy/modules
...
curl -w '\n' -D -    -X POST -H "Content-type: application/json" -d '{"srvcId": "mod-password-validator-3.1.0-SNAPSHOT", "nodeId": "localhost"}' http://localhost:9130/_/discovery/modules
...
curl -w '\n' -D - -s -X POST -H "Content-type: application/json" -d @$GITFOLIO/mod-authtoken/target/ModuleDescriptor.json http://localhost:9130/_/proxy/modules
...
curl -w '\n' -D -    -X POST -H "Content-type: application/json" -d @$workdir/DeploymentDescriptor-mod-pubsub.json http://localhost:9130/_/discovery/modules
...
curl -w '\n' -D -    -X POST -H "Content-type: application/json" -d @$workdir/DeploymentDescriptor-mod-circulation.json http://localhost:9130/_/discovery/modules
...
echo mod-inventory
curl -w '\n' -D - -s -X POST -H "Content-type: application/json" -d @$GITFOLIO/mod-inventory/target/ModuleDescriptor.json http://localhost:9130/_/proxy/modules
echo Deploy mod-inventory
$FOLIO/install-folio-backend/templates/dd-pg-kafka.sh mod-inventory 20.1.0-SNAPSHOT $JAVA_11 $GITFOLIO target/mod-inventory.jar localhost
echo Assign mod-inventory to diku
curl -w '\n' -D -    -X POST -H "Content-type: application/json" -d @$GITFOLIO/mod-inventory/target/Activate.json http://localhost:9130/_/proxy/tenants/diku/modules
