...
$FOLIO/install-folio-backend/deploy/dd-pg.sh mod-authtoken 2.14.0-SNAPSHOT $JAVA_11 $FOLIO target/mod-authtoken-fat.jar localhost
...
$FOLIO/install-folio-backend/deploy/dd-pg.sh mod-users-bl 7.6.0-SNAPSHOT $JAVA_11 $FOLIO target/mod-users-bl-fat.jar localhost
