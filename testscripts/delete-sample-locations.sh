...
curl -H "X-Okapi-Tenant: diku" -H "X-Okapi-Token: $token" -X DELETE http://localhost:9130/locations/184aae84-a5bf-4c6a-85ba-4a7c73026cd5
...
curl -H "X-Okapi-Tenant: diku" -H "X-Okapi-Token: $token" -X DELETE http://localhost:9130/location-units/libraries/c2549bb4-19c7-4fcc-8b52-39e612fb7dbe
...
curl -H "X-Okapi-Tenant: diku" -H "X-Okapi-Token: $token" -X DELETE http://localhost:9130/location-units/campuses/470ff1dd-937a-4195-bf9e-06bcfcd135df
