...
Alternatively, at module can be skipped by renaming the property `name`. Name it `skipped` instead for example:
...
## Install in one go
If Okapi is ready, it should be possible to run the install configuration like this:
