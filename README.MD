 ...
 * Check that basic as well as selected modules are checked out, built and have required artifacts present in the file system
...
## A one liner for cleaning up, validating and installing
```
